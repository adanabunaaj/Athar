        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#why" className="text-gray-300 hover:text-red-400 transition-colors duration-200">
                  Why
                </Link>
              </li>
              <li>
                <Link href="#how" className="text-gray-300 hover:text-red-400 transition-colors duration-200">
                  How
                </Link>
              </li>
              <li>
                <Link href="#vision" className="text-gray-300 hover:text-red-400 transition-colors duration-200">
                  Vision
                </Link>
              </li>
            </ul>
